...
/**
 * @brief Handles arguments and either beigns the interpret loop or evaluates given Lisp source code and exits
 *
 * The arguments are hardcoded, because so far if there are 2 or 3 args, they can only have one meaning
 *
 * @param argc count of elements in the argv array
 * @param argv array of argument values
 * @return exit status defined in err.h
...
/**
 * @brief Tokenizes, parses the source code and evaluates all outer expressions and prints their result
 *
