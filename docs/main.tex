...
Operators $+$,$-$,$*$,$/$, min and max get the values from
...
Functions quote, atom, car, nth and length
...
The set operator assigns a value to a variable in the
...
\lstinline|VARIABLE| orign, it is teated as the variable node to
...
Cdr and list work similarly by adding children to a new temporary list node.
