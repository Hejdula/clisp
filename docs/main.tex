...
I did not anticipate well what scale would this project be and it took longer than expected for a seminar work.
If this would be my first experience with C language, I would probably end up refactoring
the codebase a few times. I also underestimated how much research and analysis needed to be done before I started implementing.
