...
PC -- Programming in C language.
I will cover the assignment itself, analysis of the problem, details
of the implementation,
short guide for building and running the application and finally a
conclusion covering how the work went.
\section{Assignment}

The assignment for this seminar work is to develop a console
application in the C~programming language
that interprets a subset of the Lisp programming language (hereafter
referred to only as Lisp).
...
The interpreter must be capable of processing source code provided
...
Expressions in our Lisp can only be either a constant, list or a
symbol\slash string identifier,
...
\begin{enumerate}
  ...
  \item \textbf{N--ary tree}: Each node can have an arbitrary number
    ...
    children for each element of the list.
...
that does not appear in the structure, but it is used in Lisp.
